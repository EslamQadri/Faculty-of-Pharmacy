...
class YearAdmin(admin.ModelAdmin):
    list_display = ('name',)  # Displays the name field in the admin list view
...
class CourseAdmin(admin.ModelAdmin):
    list_display = ('name', 'year')  # Displays name and associated year
...
class PdfFilesAdmin(admin.ModelAdmin):
    list_display = ('name', 'file')  # Displays the file name and path
...
class LectureAdmin(admin.ModelAdmin):
    list_display = ('title', 'course', 'number')  # Displays title, course, and number
